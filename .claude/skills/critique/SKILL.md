---
name: critique
description: Evaluate a design's UX quality using Nielsen's heuristics scoring, cognitive load analysis, persona-based red flags, and AI slop detection. Produces a prioritized, actionable report. Use when the user asks to review, critique, evaluate, or get design feedback on a feature, page, or component.
user-invocable: true
