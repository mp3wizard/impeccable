...
**Fixes applied:** `bun install` (regenerated `bun.lock` to honor existing `package.json` overrides) + `cargo update -p rustls --precise 0.23.45` — resolved all 42 OSV-Scanner findings, re-verified clean.
